...
public interface ProdutoRepository extends JpaRepository<Produto, Long> {
    ...
    // consulta 8
    // Para cada produto, liste o preço de tabela do produto, o preço mínimo de
    // venda
    // do produto e o valor de mínimo que o produto já foi vendido em 2024 ou em
    // 2023.
    ...
    @Query(value = "SELECT " +
            ...
            "HAVING " +
            "MIN(e.quantidade) > 120", nativeQuery = true)

    List<Object[]> findProductsByFornecedor();

    // consulta 4 //testar consulta
    // Liste a quantidade e a média da quantidade de produtos em cada estoque que
    // possui
    // pelo menos 200 produtos, agrupados pelo armazém, código do estoque e
    ...
    @Query(value = "SELECT " +
            ...
            "GROUP BY " +
            "a.nome, e.codigo, c.nome", // agrupamento por armazém, código do estoque e categoria
            nativeQuery = true)
